        ...
        */
        ...
        :host(:not([type])) .popcon-content,:host(:not([type])) .popcon-body{
            ...
            <div class="popcon-content">
                ${
                  (type || this.type) !== null
                    ? '<div class="popcon-title" id="title">' +
                      this.title +
                      '</div><xy-button class="btn-close" id="btn-close" icon="close"></xy-button>'
                    : ''
                }
                ...
                ${
                  (type || this.type) === 'confirm'
                    ? '<div class="popcon-footer"><xy-button id="btn-cancel">' +
                      this.canceltext +
                      '</xy-button><xy-button id="btn-submit" type="primary">' +
                      this.oktext +
                      '</xy-button></div>'
                    : ''
                }
