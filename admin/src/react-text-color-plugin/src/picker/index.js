...
class ColorPlugin extends HTMLElement {
  ...
  constructor(options) {
    ...
    this.defaulColor = handleCSSVariables(
      options.defaultColor || this.colorCollections[0]
    );
    ...
    shadowRoot.innerHTML = `
        ...
        <section class="color-section">
            <xy-popover id="popover" ${this.dir ? "dir='" + this.dir + "'" : ''}>
                <xy-button class="color-btn" id="color-btn" ${
                    ...
                    <div class="color-sign" id="colors">
                        ${
                          (this.hasCustomPicker &&
                            `<button id="custom-picker" class="rainbow-mask"/>`) ||
                          ''
                        }
                        ${this.colorCollections
                          .map(
                            (el) =>
                              '<button class="color-cube" style="background-color:' +
                              el +
                              '" data-color=' +
                              el +
                              '></button>'
